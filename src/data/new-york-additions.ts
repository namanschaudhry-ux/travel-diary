...
export const additionalNewYorkPhotos: { image: ImageMetadata; alt: string; caption: string; tags: string[]; gps?: [number, number]; djiDate?: string; djiTime?: string }[] = [
  ...
  { image: added15, gps: [40.739494, -73.986839], alt: "A wood-panelled cafe seating area overlooking a street.", caption: "Park Avenue South, Flatiron District", tags: ["cafes"] },
  ...
  { image: added19, gps: [40.709267, -73.993889], alt: "A suspension bridge viewed from a riverside promenade.", caption: "East River Waterfront, Two Bridges", tags: ["bridges"] },
  { image: added20, gps: [40.709372, -73.994675], alt: "A bridge seen through the window of a vehicle.", caption: "FDR Drive, Two Bridges", tags: ["bridges"] },
  { image: added21, gps: [40.737172, -73.986519], alt: "An ivy-covered corner building and trees beside a crosswalk.", caption: "Irving Place, Gramercy", tags: ["green"] },
