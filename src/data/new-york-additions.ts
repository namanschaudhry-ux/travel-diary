...
export const additionalNewYorkPhotos: { image: ImageMetadata; alt: string; caption: string; tags: string[]; djiDate?: string; djiTime?: string }[] = [
  ...
  { image: added6, alt: "Sunlit skyscrapers and older buildings beneath a blue sky.", caption: "", tags: ["buildings"] },
  { image: added7, alt: "A city view through a window framed by draped fabric.", caption: "", tags: ["buildings"] },
  { image: added8, alt: "A tree-lined street with a cyclist and yellow taxi.", caption: "", tags: ["buildings"] },
  { image: added9, alt: "A brick corner building beside a row of parked blue bicycles.", caption: "", tags: ["buildings"] },
  ...
  { image: added15, alt: "A wood-panelled cafe seating area overlooking a street.", caption: "", tags: ["cafes"] },
