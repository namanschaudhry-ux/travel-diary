// Edit this file to update the About page. Swap src/assets/profile.jpg
// for a real photo whenever you like.
export const about = {
  name: "Your Name",
  tagline: "just chasing the next departure gate",
  bioShort:
  ...
  timeline: [
    {
      year: "2024",
      title: "Japan",
      description: "Three weeks chasing neon, shrines, and bamboo groves.",
    },
    {
      year: "2023",
      title: "Italy",
      description: "Coastal towns, ancient ruins, and long dinners.",
    },
    {
      year: "2022",
      title: "Iceland",
      description: "Glaciers, waterfalls, and the start of this diary.",
    },
  ],
  featured: [
    {
      label: "See the Japan gallery",
      href: "/destinations/japan/",
    },
    {
      label: "See the Italy gallery",
      href: "/destinations/italy/",
    },
  ],
  contactHref: "mailto:your@email.com",
};
